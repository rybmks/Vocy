...
//     #region Create
//
//     public async Task<Guid> AddAsync(RefreshToken token)
//     {
...
//
//     public async Task<RefreshToken> GetFirstAsync(Expression<Func<RefreshToken, bool>> expr) =>
//         await _ctx.RefreshTokens.FirstOrDefaultAsync(expr) ?? throw new InvalidOperationException();
//
//     public async Task<IEnumerable<RefreshToken>> GetAllAsync(Expression<Func<RefreshToken, bool>> expr) =>
